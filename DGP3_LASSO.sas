...
varnames="y"||("X1":"X50"); 
resu=Y||X;
create table_outliers from resu[colnames=varNames]; /* Création Table SAS pour DGP_outliers */
append from resu;
...
cardmat=nrow(Mat); /*card = nombre de variables qui ont été selectionnées */
